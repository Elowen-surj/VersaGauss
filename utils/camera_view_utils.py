    ...
    with open(cam_path) as f:
        ...
        if default_camera_index > -1:
            ...
            if move_camera:
                ...
                if current_frame < first_move_frame:
                    ...
                    position, R = get_camera_position_and_rotation(
                        init_azimuthm + (current_frame - first_move_frame) * delta_a,
                        init_elevation + (current_frame - first_move_frame) * delta_e,
                        init_radius + (current_frame - first_move_frame) * delta_r,
                        center_view_world_space,
                        observant_coordinates,
                    )
            else:
