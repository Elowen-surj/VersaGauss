...
def transform2center(position_tensor, original_mean_pos, scale_origin, center_point):
    position_tensor = position_tensor + center_point
    # original_mean_pos += (center_point) * (1 / scale_origin)
    return position_tensor, original_mean_pos

def undotransform2center(position_tensor, center_point):
    return position_tensor - center_point
...
def undo_all_transforms(input, rotation_matrices, scale_origin, original_mean_pos, center):
    return apply_inverse_rotations(
        undotransform2origin(
            undotransform2center(input, center), scale_origin, original_mean_pos
        ),
        rotation_matrices,
    )
